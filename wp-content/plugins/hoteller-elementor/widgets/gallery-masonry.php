 ...
 * @since 1.0.0
 */
class Hoteller_Gallery_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'hoteller-gallery-masonry';
	}
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'hoteller-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'hoteller-elementor' ];
	}
	...
	protected function render() {
		include(HOTELLER_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}

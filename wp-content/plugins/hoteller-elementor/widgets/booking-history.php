 ...
 * @since 1.0.0
 */
class Hoteller_Booking_History extends Widget_Base {
	...
	public function get_name() {
		return 'hoteller-booking-history';
	}
	...
	public function get_title() {
		return __( 'Booking History', 'hoteller-elementor' );
	}
	...
	protected function render() {
		include(HOTELLER_ELEMENTOR_PATH.'templates/booking-history/index.php');
	}

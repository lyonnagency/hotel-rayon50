...
class Hoteller_Distortion_Grid extends Widget_Base {
	...
	protected function _register_controls() {
			...
			[
				...
				'fields' => [
					...
					[
						...
						'default' => __( 'Excerpt' , 'hoteller-elementor' ),
					],
					[
						'name' => 'slide_link_title',
						'label' => __( 'Link Title', 'hoteller-elementor' ),
						'type' => Controls_Manager::TEXT,
						'default' => __( 'Link Title' , 'hoteller-elementor' ),
					],
					[
						'name' => 'slide_link',
		...
		$this->add_control(
		    'excerpt_font_size',
		    [
		        'label' => __( 'Excerpt Font Size (* DEPRECIATED)', 'hoteller-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 20,
		        ],
		...
		$this->add_control(
		    'link_font_size',
		    [
		        'label' => __( 'Link Font Size (* DEPRECIATED)', 'hoteller-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 18,
		        ],
		...
		$this->add_control(
		    'link_letter_spacing',
		    [
		        'label' => __( 'Link Letter Spacing (* DEPRECIATED)', 'hoteller-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 3,
		        ],
		...
		$this->add_control(
			'link_text_transform',
			[
				'label' => __( 'Link Text Transform (* DEPRECIATED)', 'hoteller-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'uppercase',
			    'options' => [
			     	'none' => __( 'None', 'hoteller-elementor' ),

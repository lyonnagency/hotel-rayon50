...
<div <?php post_class(array('blog-posts-'.$settings['layout'], 'blog-tilt', $large_grid_class, 'count_for_large_'.$count_for_large_grid, 'next_for_large'.$next_count_for_large_grid)); ?> <?php if(!empty($blog_featured_img_url)) { ?>style="background-image:url(<?php echo esc_url($blog_featured_img_url); ?>);"<?php } ?>>

                                ...
                                <div class="wrapper-hab d-flex flex-wrap ">
                                    <div class="col-12 col-md-5 text-white py-5 <?php echo $class_bg_hab ?>">
                                        <div class="col-lg-10 mx-auto py-4">
                                            ...
                                            <span class="ff-galano-bold fs-16">Desde</span>
                                            ...
                                            <div class="destacados mt-5">
                                                <div class="d-flex py-1">
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-bold fs-15 text-white">habitación:</h3>
                                                    </div>
                                                    <div class="col-6 px-0">
                                                ...
                                                <div class="d-flex py-1">
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-bold fs-15 text-white">camas:</h3>
                                                    </div>
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-semibold fs-15 text-white">
                                                            <?php
                                                ...
                                                <div class="d-flex py-1">
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-bold fs-15 text-white">capacidad:</h3>
                                                    </div>
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-semibold fs-15 text-white">
                                                            <?php
                                                ...
                                                <div class="d-flex py-1">
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-bold fs-15 text-white">recomendado:</h3>
                                                    </div>
                                                    <div class="col-6 px-0">
                                                        <h3 class="ff-galano-semibold fs-15 text-white">
                                                            <?php
...
//                                                var_dump($img_s);
                        ...
                        <section class="px-5">
                            <?php
                            echo do_shortcode("[elementor-template id=\"1614\"]");
                            echo do_shortcode("[elementor-template id=\"1617\"]");
                            echo do_shortcode("[elementor-template id=\"1620\"]");
                            ?>
                        </section>
                        <?php
                        echo do_shortcode("[elementor-template id=\"1627\"]");
                        ?>

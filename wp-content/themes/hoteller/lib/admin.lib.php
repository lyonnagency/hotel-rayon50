...
else
{
	...
	<div class="tg_notice">
					...
					<span style="color:#FF3B30">'.HOTELLER_THEMENAME.' theme support can only be activated with a valid Envato Token</span><br/><br/>
...
if(!$is_verified_envato_purchase_code)
{
	...
	<div class="tg_notice">
					<span class="dashicons dashicons-warning" style="color:#FF3B30"></span> 
					<span style="color:#FF3B30">'.HOTELLER_THEMENAME.' Demos can only be imported with a valid Envato Token</span><br/><br/>
					Please visit <a href="javascript:jQuery(\'#pp_panel_registration_a\').trigger(\'click\');">Product Registration page</a> and enter a valid Envato Token to import the full '.HOTELLER_THEMENAME.' demos and single pages through Elementor.
				</div>

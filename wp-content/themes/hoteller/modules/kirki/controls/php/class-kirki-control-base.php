...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'hoteller' ),
				'remove'         => esc_attr__( 'Remove', 'hoteller' ),
				'default'        => esc_attr__( 'Default', 'hoteller' ),
				'selectFile'     => esc_attr__( 'Select File', 'hoteller' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'hoteller' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'hoteller' ),
			)
		);

...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'hoteller' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'hoteller' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'hoteller' ),
			'200'       => esc_attr__( 'Light 200', 'hoteller' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'hoteller' ),
			'300'       => esc_attr__( 'Book 300', 'hoteller' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'hoteller' ),
			'400'       => esc_attr__( 'Normal 400', 'hoteller' ),
			'regular'   => esc_attr__( 'Normal 400', 'hoteller' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'hoteller' ),
			'500'       => esc_attr__( 'Medium 500', 'hoteller' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'hoteller' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'hoteller' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'hoteller' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'hoteller' ),
			'700'       => esc_attr__( 'Bold 700', 'hoteller' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'hoteller' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'hoteller' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'hoteller' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'hoteller' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'hoteller' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'hoteller' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'hoteller' ),
		);
	}

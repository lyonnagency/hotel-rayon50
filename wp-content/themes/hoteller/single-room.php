		...
		<div class="singleroom_one_third themeborder">
			...
			<div class="singleroom_attributes_wrapper">
				...
				<div class="singleroom_attribute">
					<div class="singleroom_bed_icon room_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon_bed.png" alt="<?php esc_html_e('Bed Type', 'hoteller' ); ?>"/></div>
				...
				?>
				<div class="singleroom_attribute">
					<div class="singleroom_adults_children_icon room_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon_people.png" alt="<?php esc_html_e('Adults & Children', 'hoteller' ); ?>"/></div>
					<div class="singleroom_adults_children room_attribute">
						<?php
							if(!empty($adults))
							{
						?>
							<?php echo esc_html($adults); ?>&nbsp;<?php esc_html_e('Adults', 'hoteller' ); ?>&nbsp;
						<?php
							}
						?>
						<?php
				...
				?>
				<div class="singleroom_attribute">
					<div class="singleroom_size_icon room_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon_size.png" alt="<?php esc_html_e('Size', 'hoteller' ); ?>"/></div>
				...
				?>
				<div class="singleroom_attribute">
					<div class="singleroom_view_icon room_icon"><img src="<?php echo get_template_directory_uri(); ?>/images/icon_view.png" alt="<?php esc_html_e('View', 'hoteller' ); ?>"/></div>
				...
				<div class="singleroom_attribute">
					...
					<div class="singleroom_view room_attribute"><?php echo esc_html($attribute['title']); ?>
					</div>
				</div>
				<?php
						} 
...
{
	$amenities_arr = get_the_terms($post, 'mphb_room_type_facility');
...
<div id="singleroom_amenities" class="singleroom_amenities">
	...
	<div class="singleroom_amenities_wrapper">
		<div class="singleroom_amenities_content">
			<div class="singleroom_amenities_label">
				<img src="<?php echo get_template_directory_uri(); ?>/images/icon_amenities.png" alt="<?php esc_html_e('Amenities', 'hoteller' ); ?>"/><?php esc_html_e('Amenities', 'hoteller' ); ?>
			</div>
	...
	<div class="singleroom_amenities_wrapper">
		<div class="singleroom_amenities_content">
			<div class="singleroom_amenities_label">
				<img src="<?php echo get_template_directory_uri(); ?>/images/icon_services.png" alt="<?php esc_html_e('Services', 'hoteller' ); ?>"/><?php esc_html_e('Services', 'hoteller' ); ?>
			</div>
			<div class="singleroom_amenities_list_wrapper">
				<ul class="singleroom_amenities_list">
				<?php
...
if(!empty($tg_accommodation_gallery))
{
	...
	{
		wp_enqueue_style('flickity', get_template_directory_uri().'/css/flickity.css', false, false, 'all' );
		wp_enqueue_script("flickity", get_template_directory_uri()."/js/flickity.pkgd.js", false, HOTELLER_THEMEVERSION, true);
		wp_enqueue_script("custom singleroom", get_template_directory_uri()."/js/core/custom singleroom.js", false, HOTELLER_THEMEVERSION, true);
?>
<br class="clear"/>
